...
M.style = function()
	...
	highlight(0, "Tabline", { bg = none, fg = light_gray })
	highlight(0, "TablineSel", { bg = none, fg = chroma_fg_delimiter })
	highlight(0, "TablineSelSymbol", { bg = none, fg = chroma_green })
	highlight(0, "TablineFill", { fg = line, bg = none })
